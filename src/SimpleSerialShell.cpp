...
//////////////////////////////////////////////////////////////////////////////
void SimpleSerialShell::addCommand(const __FlashStringHelper *name,
                                   CommandFunction f) {
...
bool SimpleSerialShell::prepInput(void) {
    ...
    do {
        int c = read();
        if (hadEsc) {
            Serial.printf("hadEsc ... 0x%x\n", c);
            if (had5b) {
                // Should have a cursor or other key
                switch (c) {
                case 0x41:
                    // UP
                    Serial.printf("UP");
...
//////////////////////////////////////////////////////////////////////////////
int SimpleSerialShell::lastErrNo(void) { return m_lastErrNo; }

//////////////////////////////////////////////////////////////////////////////
int SimpleSerialShell::report(const __FlashStringHelper *constMsg,
                              int errorCode) {
...
int SimpleSerialShell::printHistory(int, char **) {
    shell.println(F("History"));
...
void SimpleSerialShell::setTokenizer(TokenizerFunction f) { tokenizer = f; }
